...
class SecretScanRegistryImages:
    def __init__(self):
        self.registry_type = ""
    ...
    def pull_image(self, image_name_with_tag, output_folder):
        if not image_name_with_tag:
            return
        print("Pulling image", image_name_with_tag)
        pid_list = []
...
class SecretScanECRImages(SecretScanRegistryImages):
...
class SecretScanDockerHubImages(SecretScanRegistryImages):
...
class SecretScanDockerPrivateRegistryImages(SecretScanRegistryImages):
    def __init__(self, docker_pvt_registry_url, docker_pvt_registry_username, docker_pvt_registry_password,
        ...
        if not self.docker_registry_name:
            errmsg = 'SecretScanDockerPrivateRegistryImages: registry name could not be derived from {}'.format(
...
class SecretScanGoogleRegistryImages(SecretScanDockerPrivateRegistryImages):
...
class SecretScanHarborRegistryImages(SecretScanRegistryImages):
...
class SecretScanQuayRegistryImages(SecretScanRegistryImages):
...
class SecretScanGitlabRegistryImages(SecretScanRegistryImages):
...
class SecretScanJfrogRegistryImages(SecretScanRegistryImages):
